...
/**
 * Strings for component 'theme_majhub', language 'en'.
 *
 * @package    theme
 * @subpackage majhub
 * @copyright  &copy; 2016-onwards Justin Hunt
 * @author     Justin Hunt
 * @author     Based on code originally written by G J Barnard Bas Brands, David Scotson and many other contributors.
...
<div class="well">
<h3>About</h3>
<div class="lead"><p>MAJ Hub is a Bootstrap v3 based theme that has many innovative features:</p>
<ul>
...
<h3>Parent</h3>
<p>This theme is based upon the Shoehorn theme, which was created G J Barnard.</p>
</div></div>';

$string['configtitle'] = 'MAJ Hub';

$string['pluginname'] = 'MAJ Hub';

$string['credit'] = 'The MAJ Hub theme for Moodle is developed and maintained by ';
